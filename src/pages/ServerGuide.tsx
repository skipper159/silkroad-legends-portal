        ...
        <div className='container mx-auto px-4 text-center'>
          <div className='bg-black/50 p-6 rounded-lg inline-block backdrop-blur-sm'>
            <h1 className='text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-white'>
              Server Guide <span className='text-theme-accent font-cinzel text-4xl font-bold'>{theme.siteName}</span>
            </h1>
            <p className='text-lg max-w-2xl mx-auto text-theme-text-muted'>
              ...
              <div className='grid md:grid-cols-2 gap-6'>
                <div className='bg-muted/20 p-4 rounded-lg'>
                  ...
                  <ul className='space-y-2 text-muted-foreground'>
                    <li>
                      <strong>Level Cap:</strong> 110
                    </li>
                    <li>
                      <strong>Experience Rate:</strong> Custom
                    </li>
                    <li>
                      <strong>Gold Rate:</strong> Custom
                    </li>
                    <li>
                      <strong>Drop Rate:</strong> Custom
                    </li>
                  </ul>
                </div>
          ...
          <Card>
            ...
            <CardContent className='space-y-4'>
              ...
              <div className='bg-primary/10 p-4 rounded-lg border-l-4 border-primary'>
                <p className='text-sm'>
                  <strong>Note:</strong> Make sure to read the server rules before playing to ensure a fair and
        ...
        <section>
          <Card>
            ...
            <CardContent className='space-y-4'>
                ...
                <div className='space-y-3'>
                  <div>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      Check your firewall settings and ensure the game is allowed through.
                    </p>
                  </div>
                  <div>
                    <h4 className='font-semibold mb-1'>Game crashes on startup?</h4>
                    <p className='text-sm text-muted-foreground'>
                      Run the game as administrator and update your graphics drivers.
                    </p>
                  </div>
                  <div>
                    <h4 className='font-semibold mb-1'>Lost your password?</h4>
                    <p className='text-sm text-muted-foreground'>
                      Use the password recovery feature on the login page.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className='bg-primary/10 p-4 rounded-lg border-l-4 border-primary'>
                <p className='text-sm'>
                  <strong>Need more help?</strong> Contact our support team through the support ticket system or join
                  our Discord for live assistance.
                </p>
              </div>
            </CardContent>
          </Card>

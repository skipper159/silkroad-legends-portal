      ...
      <div className="py-12 bg-header-bg bg-cover bg-center">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            Game Guides <span className="text-lafftale-bronze font-cinzel text-4xl font-bold">Lafftale</span>
          </h1>
      ...
      <div className="container mx-auto px-4 py-12 space-y-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                Whether you're a complete beginner or a seasoned veteran, our guides will help you navigate the vast world of Silkroad Online. 
                We've organized everything you need into easy-to-follow sections covering gameplay mechanics, server-specific features, and advanced strategies.
              </p>
              <p className="text-muted-foreground leading-relaxed">
        ...
        <section className="grid md:grid-cols-2 gap-6">
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                Perfect for new players! Learn the fundamentals of Silkroad Online, from character creation to your first trades. 
                Covers leveling routes, mastery systems, job mechanics, equipment, and essential gameplay tips.
              </p>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                Everything you need to know about our server! Get information about server specifications, features, rates, 
                download instructions, events, and technical support.
              </p>
              <div className="space-y-2">

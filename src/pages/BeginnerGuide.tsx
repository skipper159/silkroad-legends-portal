      ...
      <main className='container mx-auto px-4 py-8'>
        ...
        <Card className='mb-12'>
          ...
          <CardContent>
            <nav className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3' aria-label='Table of Contents'>
              <a
                href='#intro'
                className='block bg-secondary/20 border border-border rounded-lg px-4 py-3 text-sm hover:bg-accent transition-colors'
              >
                1. Introduction
              </a>
              <a
          ...
          <div className='grid md:grid-cols-2 gap-6'>
            <Card className='p-6'>
              <p className='leading-relaxed mb-4'>
                ...
                <em>Triangular Conflict</em>
                between <strong>Trader</strong>, <strong>Hunter</strong>, and <strong>Thief</strong> (PvP economy) and
                for the guild endgame <strong>Fortress War</strong>. The world spans from China through Central Asia to
                Europe.
              </p>
        ...
        <section id='start' className='border-t border-border pt-8 mb-12'>
          ...
          <Card className='p-6 mb-6'>
            ...
            <ul className='space-y-2 text-muted-foreground mb-4'>
              <li>
                <strong>China</strong>: Solid solo classes, simple potion rotation, strong 1v1 scaling, flexible hybrid
                builds.
              </li>
              <li>
                <strong>Europe</strong>: Party-strong (buff synergies), clear roles (e.g. Wizard/Cleric,
                Warrior/Cleric), somewhat more demanding solo.
              </li>
            </ul>
            <p className='bg-primary/10 p-3 rounded-lg'>
              <strong>Recommendation for newcomers:</strong> CH Glaive (STR) or EU Warrior/Cleric – forgiving mistakes,
              stable farming.
            </p>
          </Card>
          ...
          <div className='grid md:grid-cols-2 gap-6'>
            <Card className='p-6'>
              ...
              <ol className='space-y-2 list-decimal list-inside text-muted-foreground'>
                ...
                <li>
                  Upgrade gear <em>step by step</em> – no expensive experiments early
                </li>
              </ol>
            </Card>
            <Card className='p-6'>
          ...
          <div className='grid md:grid-cols-2 gap-6'>
            <Card className='p-6'>
              ...
              <ul className='space-y-3 text-muted-foreground'>
                <li>
                  <strong>1–10</strong>: Starting zones around <em>Jangan</em>/<em>Constantinople</em> (Mangyang → avoid
                  Tiger Girl 😉)
                </li>
                <li>
                  <strong>10–20</strong>: Bandits/Hyongchas (Donwhang area)
                </li>
                <li>
                  <strong>20–30</strong>: Ongs / Penons – dense spawn, good EXP/HP ratio
                </li>
                <li>
                  <strong>30–40</strong>: Sonkar/Isy areas (careful), Hyeongcheons, Earth Ghosts
                </li>
              </ul>
            ...
            <Card className='p-6'>
              ...
              <ul className='space-y-2 text-muted-foreground'>
                <li>
                  NPC gear only as <em>interim solution</em>; better: drops & cheap +3/+4 at stall
                </li>
                <li>Prioritize weapons (DPS scales EXP/h strongest)</li>
                <li>
                  Blues: <em>Durability</em>, <em>Attack/Parry</em>, situationally <em>STR/INT</em>
                </li>
              </ul>
            </Card>
          </div>
          ...
          <div className='grid md:grid-cols-2 gap-6 mb-6'>
            <Card className='p-6'>
              ...
              <p className='text-muted-foreground mb-4'>
                Chinese builds combine <em>Weapon</em> (Bicheon/Heuksal/Pacheon) and <em>Element Masteries</em>{' '}
                (Fire/Cold/Light/Force). Europeans play fixed classes (Wizard/Cleric/…); sub-skills complement the role.
                Classic distributions:
              </p>
              <ul className='space-y-2 text-muted-foreground'>
                <li>
                  <strong>Pure STR</strong> – maximum physical damage/HP; tanks & melee fighters
                </li>
                <li>
                  <strong>Pure INT</strong> – maximum magical damage/MP; nukers & casters
                </li>
                <li>
                  <strong>Hybrid 2:1</strong> – e.g. <code>2 INT : 1 STR</code> or vice versa; balanced for solo PvE
                </li>
              </ul>
              <div className='bg-card border border-border rounded-lg p-4 mt-4'>
                <svg viewBox='0 0 520 120' width='100%' height='auto'>
                  ...
                  <text x='10' y='25' fill='hsl(var(--muted-foreground))' fontSize='14'>
                    Example Hybrid 2:1 INT:STR (≈ 66% INT / 34% STR)
                  </text>
                  <text x='260' y='65' textAnchor='middle' fill='hsl(var(--foreground))' fontSize='14'>
                    INT
                  </text>
                  <text x='440' y='65' textAnchor='middle' fill='hsl(var(--foreground))' fontSize='14'>
                    STR
                  </text>
                </svg>
              </div>
              <p className='text-sm bg-primary/10 p-3 rounded-lg mt-4'>
                Server caps change mastery maximum values (e.g. 300/330/360/440 points). Check the <em>current cap</em>{' '}
                of your iSRO server.
              </p>
            </Card>
            <Card className='p-6'>
        ...
        <section id='job' className='border-t border-border pt-8 mb-12'>
          ...
          <div className='grid md:grid-cols-2 gap-6 mb-6'>
            <Card className='p-6'>
              <p className='text-muted-foreground mb-4'>
                From level 20 you freely choose a role: <strong>Trader</strong> (transport goods),{' '}
                <strong>Hunter</strong> (protect) or <strong>Thief</strong> (raid). Star goods (1–5★) → more profit, but
                stronger NPC/player thieves.
                <em>Safe Trade</em> exists (lower profit, barely PvP risk).
              </p>
              <ul className='space-y-2 text-muted-foreground'>
                <li>
                  <strong>Trader:</strong> Buys specialty goods, uses transport (donkey/camel/ox etc.), sells in another
                  city for profit
                </li>
                <li>
                  <strong>Hunter:</strong> Joins traders, hunts thieves, receives bounty/job EXP
                </li>
                <li>
                  <strong>Thief:</strong> Attacks traders, steals goods, sells in hideouts; observe karma system
                </li>
              </ul>
            </Card>
            <div className='bg-card border border-border rounded-lg p-6'>
              ...
              <svg
                viewBox='0 0 600 340'
                role='img'
                aria-label='Trader-Hunter-Thief Triangle'
                width='100%'
                height='auto'
              >
                <defs>
                ...
                <g fill='none' stroke='hsl(var(--primary))' strokeWidth='2'>
                  ...
                  <text x='300' y='30' textAnchor='middle' fill='hsl(var(--primary))' fontSize='18'>
                    Hunter
                  </text>
                  <text x='60' y='310' fill='hsl(var(--chart-2))' fontSize='18'>
                    Trader
                  </text>
                  <text x='520' y='310' textAnchor='end' fill='hsl(var(--destructive))' fontSize='18'>
                    Thief
                  </text>
                  <line
                    x1='90'
          ...
          <ol className='space-y-2 list-decimal list-inside text-muted-foreground mb-6'>
            <li>
              <strong>Choose job</strong> (Trader) at Merchant Associate from Lv. 20; equip <em>Job Suit</em>
            </li>
            <li>
              <strong>Summon transport</strong> (donkey/camel/wagon) & choose star rating of goods (1★ safe → 5★ risky)
            </li>
            <li>
              Route: <em>Jangan → Donwhang</em> (beginner); optionally find hunter party
            </li>
            <li>
              At destination sell at Specialty Trader → <strong>Gold + Job EXP</strong>
            </li>
          </ol>
          ...
          <div className='grid md:grid-cols-2 gap-6'>
            ...
            <Card className='p-6'>
              ...
              <ul className='space-y-2 text-muted-foreground'>
                <li>
                  <strong>Trader Suit</strong> – Required for loading/selling; more slots with higher transport
                </li>
                <li>
                  <strong>Hunter Suit</strong> – Hunting clearance on thieves; defensive/HP relevant
                </li>
                <li>
                  <strong>Thief Suit</strong> – Access to hideouts/fences; karma colors (white/orange/red)
                </li>
                <li>
                  <strong>Transports</strong> – Donkey/camel/wagon; more stars ⇒ slower, but more profitable
                </li>
              </ul>
              <p className='text-sm bg-primary/10 p-3 rounded-lg mt-4'>
        ...
        <section id='alchemy' className='border-t border-border pt-8 mb-12'>
          ...
          <div className='grid md:grid-cols-2 gap-6 mb-6'>
            <Card className='p-6'>
              ...
              <ol className='space-y-2 list-decimal list-inside text-muted-foreground'>
                <li>
                  <em>Elixirs</em> (+ upgrade) + <em>Lucky Powder</em> (chance boost) → item plus
                </li>
                <li>
                  <em>Magic/Attribute Stones</em> → add blues/attributes (e.g. STR/INT, Durability, Attack/Parry)
                </li>
                <li>
                  Higher the plus, higher the <em>fail chance</em> – play safe: stop at +5/+7 (server dependent)
                </li>
              </ol>
              <p className='text-sm bg-primary/10 p-3 rounded-lg mt-4'>
          ...
          <div className='bg-card border border-border rounded-lg p-6 mb-6'>
            ...
            <svg viewBox='0 0 900 220' width='100%' height='auto' role='img' aria-label='Alchemy Flow'>
              <g fill='none' stroke='hsl(var(--primary))' strokeWidth='2'>
                ...
                <text x='110' y='55' textAnchor='middle' fill='hsl(var(--foreground))' fontSize='14'>
                  Choose Item
                </text>
                <rect x='230' y='20' width='200' height='60' rx='10'></rect>
                <text x='330' y='55' textAnchor='middle' fill='hsl(var(--foreground))' fontSize='14'>
                  Elixir + Lucky Powder
                </text>
                <rect x='470' y='20' width='180' height='60' rx='10'></rect>
                <text x='560' y='55' textAnchor='middle' fill='hsl(var(--foreground))' fontSize='14'>
                  Fuse (Chance)
                </text>
                <rect x='680' y='20' width='200' height='60' rx='10'></rect>
                <text x='780' y='55' textAnchor='middle' fill='hsl(var(--foreground))' fontSize='14'>
                  Success → + rises
                </text>
                <path d='M200,50 L230,50' />
                <path d='M430,50 L470,50' />
                <path d='M650,50 L680,50' />
                <rect x='680' y='120' width='200' height='60' rx='10' stroke='hsl(var(--destructive))'></rect>
                <text x='780' y='155' textAnchor='middle' fill='hsl(var(--destructive))' fontSize='14'>
                  Fail → plus/stats may drop
                </text>
          ...
          <ul className='space-y-2 text-muted-foreground mb-6'>
            <li>
              <strong>Seal of Star (SoS)</strong> – roughly ≈ <em>+5 Level</em> over Normal
            </li>
            <li>
              <strong>Seal of Moon (SoM)</strong> – roughly ≈ <em>+10 Level</em>
            </li>
            <li>
              <strong>Seal of Sun (SoSun)</strong> – roughly ≈ <em>+15 Level</em>, extremely rare
            </li>
          </ul>
        ...
        <section id='grinding' className='border-t border-border pt-8 mb-12'>
          ...
          <ul className='space-y-2 text-muted-foreground mb-6'>
            <li>
              <strong>Solo</strong>: Bow/Wizard/Rogue clear fastest; Blade/Warrior safer, but slower
            </li>
            <li>
              <strong>Full PT (EU)</strong>: 2× Wizard, 1× Warlock, 1× Warrior, 1× Bard, 1–2× Cleric, 1× Rogue (Lure)
            </li>
          </ul>

          <h3 className='text-xl font-semibold mb-4'>Auto-Potion & Botting (Reality)</h3>
          <p className='text-muted-foreground'>
            Use Auto-Potion in client (HP 80%, MP 60%, Vigor 50–60%). Bot density varies – play hotspots at off-peak
            times.
          </p>
        </section>
        ...
        <section id='dungeons' className='border-t border-border pt-8 mb-12'>
          ...
          <Card className='p-6 mb-6'>
            <ul className='space-y-2 text-muted-foreground'>
              <li>
                <strong>Forgotten World (FGW)</strong>: Collect talismans (maps), boss runs; rewards for sets/weapons
              </li>
              <li>
                <strong>Donwhang Cave</strong>, <strong>Qin-Shi Tomb</strong>, <strong>Jupiter Temple</strong>:
                Level-dependent group instances with robust drops
              </li>
              <li>
                <strong>Uniques</strong>: World bosses (e.g. Tiger Girl, Isyutaru, Lord Yarkan) – keep track of
                timers/spawns
              </li>
            </ul>
          </Card>
          ...
          <ol className='space-y-2 list-decimal list-inside text-muted-foreground mb-6'>
            <li>
              <strong>Find & destroy Dimension Pillar</strong> → <em>Envies</em> spawn
            </li>
            <li>
              Kill Envies → <strong>Dimension Hole</strong> drops (time limited)
            </li>
            <li>
              Use <em>Hole</em> in town → enter instance, collect talismans
            </li>
          </ol>
          ...
          <div className='grid md:grid-cols-3 gap-4 mb-6'>
            ...
            <figure className='bg-card border border-border rounded-lg p-4'>
              ...
              />
              <figcaption className='text-sm text-muted-foreground mt-2'>
                Dimension Hole in town – instance access
              </figcaption>
            </figure>
          </div>
          ...
          <ul className='space-y-2 text-muted-foreground mb-6'>
            <li>
              <strong>Roc Mountain</strong> – High-level area/boss; PT drops
            </li>
            <li>
              <strong>Jangan Cave (Qin-Shi Tomb)</strong> – Multi-floor, 80–100+; PT friendly
            </li>
          </ul>
        </section>
        ...
        <section id='economy' className='border-t border-border pt-8 mb-12'>
          ...
          <div className='grid md:grid-cols-2 gap-6 mb-6'>
            <Card className='p-6'>
              ...
              <ul className='space-y-2 text-muted-foreground'>
                ...
                <li>
                  Farm spots with high <em>mob density</em> + low potion ratio
                </li>
          ...
          <ul className='space-y-2 text-muted-foreground mb-6'>
            <li>
              <strong>Stall Network</strong>: List items without being online; note fees; use peak times
            </li>
            <li>
              <strong>Consignment</strong>: Specialty goods server-wide; can trigger job events
            </li>
            <li>
              <strong>Silk Items</strong>: Premium/VIP (EXP/SP bonuses), pets, inventory expansions, alchemy securities
            </li>
          </ul>
        </section>
        ...
        <section id='endgame' className='border-t border-border pt-8 mb-12'>
          ...
          <ul className='space-y-2 text-muted-foreground mb-6'>
            <li>
              <strong>Fortress War</strong>: Timed battles; organization & target calls beat raw gear score
            </li>
            <li>
              <strong>Guild Wars</strong>: Open battles; train buff sync & focus targets
            </li>
          </ul>
          ...
          <ul className='space-y-2 text-muted-foreground mb-6'>
            <li>
              <strong>EU</strong>: Warrior/Cleric as anchor; Wizard stacks; Warlock debuffs; Bard songs
            </li>
            <li>
              <strong>CH</strong>: Spear INT nuker (Lightning/Cold), Glaive STR front, Bow kite (Fire/Light)
            </li>
          </ul>
          ...
          <ul className='space-y-2 text-muted-foreground mb-6'>
            <li>
              <strong>Alexandria</strong> → Temple & Job Temple Uniques: Coins/materials for EGY/Nova sets
            </li>
            <li>
              <strong>Jupiter Temple</strong>: High-end instances (server dependent)
            </li>
          </ul>
        </section>
        ...
        <section id='crafting' className='border-t border-border pt-8 mb-12'>
          ...
          <Card className='p-6'>
            <p className='text-muted-foreground mb-4'>
              ...
              farm materials, craft chance-based (on fail materials are lost). This allows building special
              weapons/items.
            </p>
            <ul className='space-y-2 text-muted-foreground'>
              <li>
                <strong>Recipes</strong>: Drop from mobs/instances; must be registered in crafting UI
              </li>
              <li>
                <strong>Materials</strong>: From drops, dismantle/salvage of gear, events
              </li>
              <li>
                <strong>Success chance</strong>: Varies per item/grade; <em>fail destroys materials</em>
              </li>
            </ul>
            <p className='text-sm bg-primary/10 p-3 rounded-lg mt-4'>
              Practice: First skill/test cheap recipes, later craft expensive weapons. Balance material bottlenecks via
              guild/market.
            </p>
          </Card>
        </section>
        ...
        <section id='fortress' className='border-t border-border pt-8 mb-12'>
          ...
          <div className='grid md:grid-cols-2 gap-6 mb-6'>
            <Card className='p-6'>
              <p className='text-muted-foreground mb-4'>
                Guilds fight for fortresses (e.g. Jangan/Hotan) – winner receives prestige, <em>tax income</em> and
                strategic advantages. Structure: outer walls, gates, watchtowers, barricades, heart. Roles: attackers
                break through → destroy heart; defenders repair/hold positions.
              </p>
              <ul className='space-y-2 text-muted-foreground'>
                <li>
                  <strong>Preparation</strong>: Shift setup (frontline, flanker, utility), alchemy buff food, speed
                  drugs, flags
                </li>
                <li>
                  <strong>Attack</strong>: Synchronized ram pushes, tower focus, port cuts, secure respawn points
                </li>
                <li>
                  <strong>Defense</strong>: Gate rotation (repair), anti-wizard screens, retreat markers
                </li>
              </ul>
            </Card>
            <figure className='bg-card border border-border rounded-lg p-4'>
        ...
        <section id='tips' className='border-t border-border pt-8 mb-12'>
          ...
          <div className='grid md:grid-cols-2 gap-6'>
            <Card className='p-6'>
              ...
              <ul className='space-y-2 text-muted-foreground'>
                <li>
                  <strong>Solo</strong>: Safe builds, consistent spots, moderate alchemy
                </li>
                <li>
                  <strong>Party</strong>: Clarify roles (heals/taunts/bursts), spawn kiting
                </li>
                <li>
                  <strong>Job</strong>: Increase stars slowly; thief activity server dependent
                </li>
                <li>
                  <strong>Fortress</strong>: Discord required, clear calls, respawn points
                </li>
              </ul>
            </Card>
            <Card className='p-6'>
              ...
              <ul className='space-y-2 text-sm text-muted-foreground'>
                <li>
                  Wiki (Fandom):{' '}
                  <a
                    href='https://silkroadonline.fandom.com/wiki/Map'
                    target='_blank'
                    rel='noopener'
                ...
                <li>
                  Job System:{' '}
                  <a
                    href='https://silkroadonline.fandom.com/wiki/Job'
                    target='_blank'
                    rel='noopener'
                    className='text-primary hover:underline'
                  >
                ...
                <li>
                  Interactive Map:{' '}
                  <a
                    href='https://jellybitz.github.io/xSROMap/'
                    target='_blank'
                    rel='noopener'
                    className='text-primary hover:underline'
                  >
                ...
                <li>
                  Alchemy Video:{' '}
                  <a
                    href='https://www.youtube.com/watch?v=zNflGM1_3Ek'
                    target='_blank'
                    rel='noopener'
                    className='text-primary hover:underline'
                  >
                ...
                <li>
                  Jobbing Video:{' '}
                  <a
                    href='https://www.youtube.com/watch?v=neMQVw-zDbA'
                    target='_blank'
                    rel='noopener'
                    className='text-primary hover:underline'
                  >

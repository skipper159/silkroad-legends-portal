            ...
            <Card className="border-lafftale-gold/30 mb-6">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-6">
                  <div className="border-[0.5px] border-lafftale-gold/20 rounded-lg p-4">
                    <h3 className="text-xl font-semibold mb-2">1. Selling Silk Items</h3>
                    <p className="text-muted-foreground mb-2">Selling silk items/accounts or cross-server trading is forbidden.</p>

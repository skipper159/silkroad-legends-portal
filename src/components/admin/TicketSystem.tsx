...
const TicketSystem = () => {
    ...
    const fetchTickets = async () => {
        ...
        try {
            const res = await fetchWithAuth(
                `${weburl}/api/admin_tickets/tickets/open`
            );
    ...
    const fetchTicketMessages = async (ticket: Ticket) => {
        ...
        try {
            const res = await fetchWithAuth(
                `${weburl}/api/user_tickets/${ticket.Id}`
            );
    ...
    const sendReply = async () => {
        ...
        await fetchWithAuth(
            `${weburl}/api/user_tickets/${selectedTicket?.Id}/message`,
            {
                method: "POST",
                        ...
                        <>
                            <div className="space-y-3 max-h-[70vh] overflow-y-auto">
                                {messages.map((msg) => {
                                    ...
                                    const shortText = msg.Message.slice(
                                        0,
                                        MAX_PREVIEW_LENGTH
                                    );
